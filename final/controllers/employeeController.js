...
exports.employees_add_post = async function(req, res, next) {
    ...
    if (result.isEmpty() != true){
      ...
      const newEmployee = new Employee('', req.body.idNum, req.body.firstName, req.body.lastName, req.body.department, req.body.notes, '');
...
exports.employees_post_edit = async function(req, res, next) {
    ...
    if (result.isEmpty() != true){
        ...
        const updatedEmployee = new Employee(req.params.id, req.body.idNum, req.body.firstName, req.body.lastName, req.body.department, req.body.notes);
